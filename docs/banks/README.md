...
| 场景 | 农行 | 建行 | 中行 |
|---|---|---|---|
| 普通消费 | ✅（68 笔境外、4 笔网上） | ✅（28 笔欧洲消费） | ✅ 样本已有（2025-06），解析在 M5 |
| 退款 | ❌ | ❌ | ❌ |
| 还款 | ✅ | ✅ | 待 M5 确认 |
| 外币 / 双币卡 | ✅（澳元消费按美元入账） | ✅（欧元、瑞士法郎、美元消费按人民币入账） | ✅（澳元单币账户） |
| 自动购汇还款 | ✅ | ❌ | ❌ |
| 返现 | ✅（52 笔） | ✅（41 笔） | ✅ 样本已有，解析在 M5 |
| 分期本金和利息 | ✅（总账分期 3/36） | ❌ | ❌ |
| 年费、手续费、取现 | ❌ | ❌ | ❌ |
| 溢缴款 | ✅ | ❌ | ✅（存款余额 0.07） |
| 未列明细的调整 | ✅（0.62） | ❌ | ❌ |
...
| 多卡合并 | —（每卡一封） | ❌ | ✅ 样本已有（两卡），解析在 M5 |
| 多期（补样本 P1b 要求 ≥3 期） | ❌（每卡 1 期） | ❌（2 期） | ❌（2 期） |

**最缺的样本**（2026-09-19 更新）：有消费的建行账单、有明细的中行账单已补齐；还缺退款、年费、取现，以及每张卡再补 1–2 期。
